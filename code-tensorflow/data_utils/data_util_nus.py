...
# ③ nus
def get_views(view_data_dir='/home/lishuai_lxy/fph/NUS'):
    num_views = 7
    view_train_x = []
    view_test_x = []
...
def load_teacher_logits(view_data_dir='views', models_ls=None):
    models_ls = ['Normalized_CH', 'Normalized_CM55', 'Normalized_CORR', 'Normalized_EDH', 'Normalized_WT', 'BoW_int', 'tags1k']
